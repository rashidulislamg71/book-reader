...
function BookCard() {
    return (
        <div className=' '>
            <div className='group cursor-pointer hover:shadow-xl duration-300 transition-all w-70 h-90 p-4 border border-gray-200 rounded-2xl flex flex-col gap-3  justify-between'>
                ...
                <div className='pt-2 w-full border-t border-gray-600 flex justify-between items-center' >
